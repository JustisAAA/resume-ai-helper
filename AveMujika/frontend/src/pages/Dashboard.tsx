...
// 人岗匹配图标（与 ToolsMatch.tsx 标题区一致：放大镜）
...
const CARD_STYLE: Record<string, {
  ...
  'upload': {
    gradientBar: 'from-indigo-400 via-indigo-500 to-indigo-600',
    hoverCircleBg: 'bg-indigo-50',
  ...
  'guide': {
    gradientBar: 'from-teal-400 via-teal-500 to-emerald-500',
    hoverCircleBg: 'bg-teal-50',
  ...
  'question': {
    gradientBar: 'from-cyan-400 via-cyan-500 to-teal-500',
  ...
  const fetchData = async () => {
    try {
      ...
      const [interviews, resumes] = await Promise.all([
        interviewAPI.list(token!).catch(() => [] as never[]),
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-950 transition-colors">
      ...
      <nav className="bg-white dark:bg-gray-900/80 backdrop-blur-md border-b border-gray-100 dark:border-gray-800 sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex justify-between items-center h-16">
          ...
          <div className="flex items-center gap-3">
            ...
            <button onClick={() => navigate('/profile')} className="w-8 h-8 rounded-full bg-gradient-to-br from-indigo-100 to-purple-100 dark:from-indigo-900/30 dark:to-purple-900/30 flex items-center justify-center text-sm font-bold text-indigo-600 dark:text-indigo-400 border border-indigo-200/50 dark:border-indigo-800/50 hover:shadow-md transition-all cursor-pointer overflow-hidden">
              {user?.avatar ? (
            ...
            <button onClick={toggleTheme} className="w-8 h-8 rounded-lg flex items-center justify-center text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors" title={dark ? '切换到浅色模式' : '切换到深色模式'}>
              {dark ? (
            ...
            <button onClick={handleLogout} className="text-sm text-gray-600 dark:text-gray-300 hover:text-gray-900 dark:text-white dark:hover:text-gray-100 px-3 py-1.5 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors">
              退出
            </button>
          </div>
        </div>
      ...
      <div className="relative">
        {/* 背景装饰 */}
        <div className="absolute top-20 left-0 w-72 h-72 bg-indigo-200/20 rounded-full blur-3xl" />
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            {FEATURE_CARDS.map((card) => {
              ...
              return (
                <button
                  ...
                  className="group relative bg-white dark:bg-gray-900 rounded-2xl p-6 hover:shadow-xl hover:-translate-y-1 transition-all duration-300 text-left w-full overflow-hidden border border-gray-100 dark:border-gray-800"
                >
                  {/* 顶部渐变色条 */}
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-5">
            ...
            <button
              ...
              className="group relative bg-white dark:bg-gray-900 rounded-2xl border border-gray-100 dark:border-gray-800 p-6 hover:shadow-lg hover:border-indigo-100 transition-all duration-300 text-left w-full overflow-hidden"
            >
              ...
              <div className="flex items-start justify-between">
                <div>
                  ...
                  <p className="text-xs text-indigo-600 font-medium mt-1 opacity-0 group-hover:opacity-100 transition-opacity duration-200">
                    管理简历 →
                  </p>
                </div>
                <div className="w-12 h-12 rounded-xl bg-indigo-50 flex items-center justify-center group-hover:bg-indigo-100 group-hover:scale-110 transition-all duration-200">
            ...
            <button
              ...
              className="group relative bg-white dark:bg-gray-900 rounded-2xl border border-gray-100 dark:border-gray-800 p-6 hover:shadow-lg hover:border-purple-100 transition-all duration-300 text-left w-full overflow-hidden"
            >
            ...
            <button
              ...
              className="group relative bg-white dark:bg-gray-900 rounded-2xl border border-gray-100 dark:border-gray-800 p-6 hover:shadow-lg hover:border-emerald-100 transition-all duration-300 text-left w-full overflow-hidden"
            >
              ...
              <div className="flex items-start justify-between">
                <div>
                  ...
                  <p className="text-xs text-emerald-600 font-medium mt-1 opacity-0 group-hover:opacity-100 transition-opacity duration-200">
                    查看报告 →
                  </p>
                </div>
                <div className="w-12 h-12 rounded-xl bg-emerald-50 flex items-center justify-center group-hover:bg-emerald-100 group-hover:scale-110 transition-all duration-200">
                  <ReportIcon className="w-6 h-6 text-emerald-600" />
                </div>
              </div>
            </button>
          </div>
