    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-gray-900 px-4">
      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-500 dark:text-gray-500 mt-1">注册你的 AI 求职助手账号</p>
        </div>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-8">
          ...
          <p className="mt-6 text-center text-sm text-gray-500 dark:text-gray-500">
            已有账号？
            <Link to="/login" className="text-brand-600 dark:text-brand-400 hover:text-brand-700 dark:text-brand-300 font-medium ml-1">
              立即登录
            </Link>
          </p>
        </div>
