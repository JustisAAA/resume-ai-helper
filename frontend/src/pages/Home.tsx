      ...
      <section className="relative overflow-hidden pt-20 pb-24 sm:pt-28 sm:pb-32">
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg sm:text-xl text-gray-600 dark:text-gray-300 max-w-2xl mx-auto mb-10 leading-relaxed">
            智能简历分析、AI 简历评分、模拟面试、求职攻略、简历模板、AI 模板生成——六大核心功能，
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 gap-x-6 gap-y-10">
            {[
              ...
              { step: '3', title: '简历模板', desc: '5 款专业模板，一键生成精美简历' },
              { step: '4', title: '模拟面试', desc: '基于简历生成个性化面试题，实时对话评估' },
              { step: '5', title: '求职攻略', desc: 'AI 提供求职全阶段实用建议和工具' },
              { step: '6', title: '查看报告', desc: '获取多维度评分和针对性提升建议' },
            ].map((s, i) => (
